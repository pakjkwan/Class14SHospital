...
<script> $(function() { $("#btn-addr").postcodifyPopUp(); }); </script>
							...
							<div class="col-lg-12">
								<form id="login-form" action="#" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" value="hong">
									</div>
									<div class="form-group">
										<input type="password" name="password" id="password" tabindex="2" class="form-control" value="1">
									</div>
								 ...
								 <form id="register-form" role="form" style="display: none;">
								    ...
								    <label class="radio-inline">
								      	<input type="radio" name="group" value="admin" >관리자
								    </label>
								    ...
								    <!-- "id","pass","name","gen","phone","email","job","jumin","addr" -->
									    ...
									    <label class="radio-inline">
									      	<input type="radio" name="gen" value="femail" >여
									    </label>
									    <div class="form-group" style="margin-top: 10px">
